<template>
  <div class="m-md-5 m-sm-4 m-3 d-flex flex-column document">
    ...
    <div class="document-content mb-4">
      <h2 id="title-2" class="pb-3 mb-4">
        <a href="#title-2">Vue.js是什么</a>
      </h2>
      <p>
        Vue (读音 /vjuː/，类似于 view)
        是一套用于构建用户界面的渐进式框架。与其它大型框架不同的是，Vue
    ...
    <div class="document-content mb-4">
      <h2 id="title-3" class="pb-3 mb-4">
        <a href="#title-3">Vue.js是什么</a>
      </h2>
      <p>
        Vue (读音 /vjuː/，类似于 view)
        是一套用于构建用户界面的渐进式框架。与其它大型框架不同的是，Vue
    ...
    <div class="document-content mb-4">
      <h2 id="title-4" class="pb-3 mb-4">
        <a href="#title-4">Vue.js是什么</a>
      </h2>
      <pre class="pt-4">
        const a = () => {
          console.log('aaa')
